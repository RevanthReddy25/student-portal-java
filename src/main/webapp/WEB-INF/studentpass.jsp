...
<%
    try {
        ...
        PreparedStatement ps = con.prepareStatement("SELECT pass FROM students.login WHERE rollno = ?");
        ps.setString(1, str1);
        ...
        if (rs.next()) {
            ...
            if (str2.equals(passwordFromDB)) {
                ...
                if (str3.equals(str4)) {
                    ...
                    PreparedStatement updatePs = con.prepareStatement("UPDATE students.login SET pass = ? WHERE rollno = ?");
                    ...
                    out.println("window.location.href='studentprofile.jsp?rollno=str1';");
                    out.println("</script>");
                } else {
                    out.println("<script>");
                    out.println("alert('MISMATCH OF PASSWORDS !');");
                    out.println("window.location.href='studentpass.html';");
                    out.println("</script>");
                }
            } else {
                out.println("<script>");
